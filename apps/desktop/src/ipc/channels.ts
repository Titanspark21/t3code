...
export const LOG_DIR_CHANNEL = "desktop:log-dir";
export const LOG_LIST_CHANNEL = "desktop:log-list";
export const LOG_READ_CHANNEL = "desktop:log-read";
export const LOG_OPEN_DIR_CHANNEL = "desktop:log-open-dir";
