...
export const QueuedThreadMessageSchema = Schema.Struct({
  ...
  deliveryMode: Schema.optional(Schema.Literals(["immediate", "after-active-turn"])),
...
export interface QueuedThreadMessage {
  ...
  readonly deliveryMode?: "immediate" | "after-active-turn";
...
export function resolveThreadOutboxDeliveryAction(input: {
  ...
  if (input.threadBusy && input.waitForIdle) {
    return "wait";
  }
