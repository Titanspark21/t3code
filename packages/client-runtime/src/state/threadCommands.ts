...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    appendActivity: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:append-activity",
      execute: (input: AppendThreadActivityInput) => appendThreadActivity(input),
      scheduler,
      concurrency,
    }),
